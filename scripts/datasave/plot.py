...
def plot_pos():
    ...
    plt.grid(True)
    #plt.ylim((-2, 2))
    #plt.yticks(np.arange(-2.5,8, 0.5))
    plt.xlabel('time(s)')
    plt.title('X')
...
def plot_v():
    plt.figure()
    plt.subplot(1, 3, 1)
    plt.plot(time, ref_v[:, 0], 'red')
    plt.plot(time, uav_v[:, 0], 'blue')
    plt.grid(True)
    #plt.ylim((-2, 2))
    #plt.yticks(np.arange(-2.5,8, 0.5))
    plt.xlabel('time(s)')
    ...
    plt.subplot(1, 3, 2)
    plt.plot(time, ref_v[:, 1], 'red')
    plt.plot(time, uav_v[:, 1], 'blue')
    plt.grid(True)
    #plt.ylim((-2, 2))
    #plt.yticks(np.arange(-2.5, 8, 0.5))
    plt.xlabel('time(s)')
    ...
    plt.subplot(1, 3, 3)
    plt.plot(time, ref_v[:, 2], 'red')
    plt.plot(time, uav_v[:, 2], 'blue')
    plt.grid(True)
    #plt.ylim((0, 2))
